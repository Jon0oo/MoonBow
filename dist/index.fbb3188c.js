...
})({"cAoqI":[function(require,module,exports,__globalThis) {
...
parcelHelpers.export(exports, "scrollToSlide", ()=>scrollToSlide);
...
function setupDropdowns() {
    ...
    document.addEventListener('click', function(event) {
        if (!event.target.closest('.menu')) document.querySelectorAll('.dropdown.show').forEach((dropdown)=>dropdown.classList.remove('show'));
    });
}
function scrollToSlide(event, slideId) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    (0, _animationsJs.observeSlides)();
    (0, _animationsJs.setupDotNavigation)();
});
...
},{"./animations.js":"cS1jW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cS1jW":[function(require,module,exports,__globalThis) {
// Moves the indicator to the active dot's position.
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateIndicatorPosition", ()=>updateIndicatorPosition);
// Observe slides and update the indicator.
parcelHelpers.export(exports, "observeSlides", ()=>observeSlides);
// Set up click functionality for the navigation dots.
parcelHelpers.export(exports, "setupDotNavigation", ()=>setupDotNavigation);
function updateIndicatorPosition(activeDot) {
...
},{}]},["cAoqI","bDbGG"], "bDbGG", "parcelRequire94c2")
