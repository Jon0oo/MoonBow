...
})({"abKpP":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "db5abc605cd8d7a8";
"use strict";
...
},{}],"04tc3":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _gsap = require("gsap"); // assuming gsap is bundled via Parcel or similar
...
(0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger), (0, _customEase.CustomEase));
/* === Animated Text Timelines (unchanged) === */ const tl = (0, _gsap.gsap).timeline({
    defaults: {
        duration: 2,
        yoyo: true,
        ease: 'power2.inOut'
...
/* === Custom SVG Drawing Animation Using Locomotive Scroll === */ // Remove the GSAP ScrollTrigger code for the ".draw" element.
// Instead, we update it based on Locomotive Scroll progress over Slide 1.
// Set up Locomotive Scroll
const scroll = new (0, _locomotiveScrollDefault.default)({
    el: document.querySelector('[data-scroll-container]'),
    smooth: true,
    multiplier: 0.1 // Adjust multiplier as needed
});
// Assume your SVG path has a total dash length of 1000
const totalDash = 1000;
const slide1El = document.querySelector('.slide1');
const svgDrawEl = document.querySelector('.draw');
// Optionally, set the initial dash properties if not set in CSS
svgDrawEl.style.strokeDasharray = totalDash;
svgDrawEl.style.strokeDashoffset = totalDash;
// On every locomotive scroll event, update the drawing based on the progress of Slide 1
scroll.on('scroll', (args)=>{
    // Get the bounding rectangle of Slide 1 relative to the viewport
    const rect = slide1El.getBoundingClientRect();
    // Calculate progress: when the top of slide1 is at the bottom of the viewport,
    // progress = 0; when the bottom of slide1 reaches the top of the viewport, progress = 1.
    const progress = Math.min(Math.max((window.innerHeight - rect.top) / (rect.height + window.innerHeight), 0), 1);
    // Update the strokeDashoffset from totalDash to 0 as progress goes from 0 to 1
    svgDrawEl.style.strokeDashoffset = totalDash * (1 - progress);
}); // (Optional) If you have other locomotive-scroll integrations, you might want to listen for refresh events
 // For example: scroll.update();

},{"locomotive-scroll":"iDXE3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","gsap/CustomEase":"1y1UF"}],"iDXE3":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["abKpP","04tc3"], "04tc3", "parcelRequire94c2")

//# sourceMappingURL=index.5cd8d7a8.js.map
